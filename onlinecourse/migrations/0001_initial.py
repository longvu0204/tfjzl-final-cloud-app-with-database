# Generated by Django 4.2.3 on 2026-05-30 10:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choice_text', models.CharField(default='Choice text', max_length=500)),
        ...
        migrations.AddField(
            model_name='course',
            name='users',
            field=models.ManyToManyField(related_name='course_users', through='onlinecourse.Enrollment', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='choice',
            name='question',
